...
// /generate, /charts, /text-to-config, /compose-to-config to chartpress-server
// and / to the SPA). For `npm run dev`, proxy those API paths to a local server
// (default :8080, override with CHARTPRESS_API). See src/app/api.js.
